...
$oldSetArray_c6fc83e9c3551eec516f1d53b4dc83cb = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '">
<div class="label">Recherche : </div><div class="search-line"><form action="/ezpublish/index.php/site/content/search" method="get"><input class="searchinput" type="text" size="10" name="SearchText" value="" />
...
$setArray = $oldSetArray_c6fc83e9c3551eec516f1d53b4dc83cb;
$tpl->Level--;
?>
