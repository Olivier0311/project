...
$oldSetArray_393eaaeea75a9e58f7914cb945878861 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '">
                    <img src="/ezpublish/design/standard/images/edit.gif" width="16" height="16" border="0" alt="Modifier" />
                </a>
            </td>
        </tr>
    ';
...
$setArray = $oldSetArray_393eaaeea75a9e58f7914cb945878861;
$tpl->Level--;
?>
