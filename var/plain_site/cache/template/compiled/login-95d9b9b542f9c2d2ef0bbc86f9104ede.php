...
$oldSetArray_a812ed0719719c3cce63aaa54d4fb3a5 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '<a href="/ezpublish/user/login">Ouverture de session</a>&nbsp;';
}
else
{
$text .= '<a href="/ezpublish/user/logout">Fermeture de session(';
unset( $var );
unset( $var1 );
unset( $var1 );
...
$setArray = $oldSetArray_a812ed0719719c3cce63aaa54d4fb3a5;
$tpl->Level--;
?>
