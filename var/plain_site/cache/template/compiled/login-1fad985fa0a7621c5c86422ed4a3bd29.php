...
$oldSetArray_5e8d79de1b86243a197668bf4390e34e = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '<a href="/ezpublish/index.php/site/user/login">Ouverture de session</a>&nbsp;';
}
else
{
$text .= '<a href="/ezpublish/index.php/site/user/logout">Fermeture de session(';
unset( $var );
unset( $var1 );
unset( $var1 );
...
$setArray = $oldSetArray_5e8d79de1b86243a197668bf4390e34e;
$tpl->Level--;
?>
