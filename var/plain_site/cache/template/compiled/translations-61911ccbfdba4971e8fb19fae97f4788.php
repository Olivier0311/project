...
// Timestamp: 1335946337 (Wed May 2 10:12:17 CEST 2012)
$oldSetArray_641f5dabbdb736a8cfbb4b167071e972 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<form name="translationsform" method="post" action="/ezpublish/index.php/site_admin/content/translation">
...
<tr>
    <th class="tight"><img src="/ezpublish/design/admin2/images/toggle-button-16x16.gif" width="16" height="16" alt="Inverser la sélection." title="Inverser la sélection." onclick="ezjs_toggleCheckboxes( document.translationsform, \'LanguageID[]\' ); return false;"/></th>
    <th>Langue</th>
...
$text .= '><img src="/ezpublish/design/standard/images/edit.gif" width="16" height="16" alt="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$setArray = $oldSetArray_641f5dabbdb736a8cfbb4b167071e972;
$tpl->Level--;
?>
