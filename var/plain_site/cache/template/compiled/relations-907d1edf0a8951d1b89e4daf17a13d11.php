...
$oldSetArray_96b318e86d3a286eb64defbd3141121b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/text_linked-f8be6b5daabbd802a5429beeea08e4f8.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/plain_site/cache/template/compiled/text_linked-f8be6b5daabbd802a5429beeea08e4f8.php' );
...
$text .= '</td>
            <td>
                ';
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_103 );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1031 );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1031 );
$elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1031 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute_id', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute_id'] : null;
if (! isset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1031 ) ) $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1031 = NULL;
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1031 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1031, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1031 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1031->templateValue();
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1031 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1031, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1031 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1031->templateValue();
$elseif_cond_8ef0bd49181921a6cf6168619ad677e3_103 = ( ( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1031 ) == ( 0 ) );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1031 );
if (! isset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_103 ) ) $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_103 = NULL;
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_103 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_103, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_103 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_103->templateValue();
...
elseif ( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_103 )
{
$text .= '                    ';
...
$text .= '</td>
            <td>
                ';
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_111 );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1111 );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1111 );
$elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1111 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute_id', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute_id'] : null;
if (! isset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1111 ) ) $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1111 = NULL;
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1111 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1111, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1111 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1111->templateValue();
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1111 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1111, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1111 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1111->templateValue();
$elseif_cond_8ef0bd49181921a6cf6168619ad677e3_111 = ( ( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1111 ) == ( 0 ) );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1111 );
if (! isset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_111 ) ) $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_111 = NULL;
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_111 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_111, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_111 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_111->templateValue();
...
elseif ( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_111 )
{
$text .= '                    ';
// def $relation_name_array
if ( $tpl->hasVariable( 'relation_name_array', $rootNamespace ) )
...
$text .= '</table>';
$oldRestoreIncludeArray_6e7c567f32564229ad099fef52d116ff = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_6e7c567f32564229ad099fef52d116ff;


$setArray = $oldSetArray_96b318e86d3a286eb64defbd3141121b;
$tpl->Level--;
?>
